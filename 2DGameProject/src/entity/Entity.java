...
//	public int changeDirection4 = 0;
	...
	public void draw(Graphics2D g2) {
		...
		// RENDERING (For game performance)
		...
		if(inCamera() == true) {
			...
			if(invincible == true) {
				hpBarOn = true;
				hpBarCounter = 0;
				changeAlpha(g2, 0.4f); // Reduce opacity	    
			}
			if(dying == true) {
				dyingAnimation(g2);
			}
			...
			changeAlpha(g2, 1f); // Reduce opacity
		}
	...
	public void dyingAnimation(Graphics2D g2) {
		...
		// MONSTER DYING ANIMATION (BLINKING IMAGE)
	...
	public void searchPath(int goalCol, int goalRow) {
		...
		if(gp.pFinder.search() == true) {
			...
			// If reaches the goal, stop the search (DISABLE IF FOLLOW PLAYER)
