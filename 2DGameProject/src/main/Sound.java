...
public class Sound {
	...
	public Sound() {
		...
		soundURL[0] = getClass().getResource("/sound/puzzle_game.wav");
		...
		soundURL[10] = getClass().getResource("/sound/titlescreenmusic.wav");
		...
		soundURL[20] = getClass().getResource("/sound/dungeon1.wav");
		soundURL[21] = getClass().getResource("/sound/chipwall.wav");
		soundURL[22] = getClass().getResource("/sound/dooropen.wav");
		soundURL[23] = getClass().getResource("/sound/final_boss.wav");
		soundURL[24] = getClass().getResource("/sound/pillarman.wav");
